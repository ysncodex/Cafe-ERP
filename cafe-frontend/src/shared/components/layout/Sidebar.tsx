...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      {/* ── Navigation ── */}
      <nav className="flex-1 overflow-y-auto overflow-x-hidden px-2 pb-3 scroll-smooth">
      ...
      {/* ── Sign out ── */}
      <div className="shrink-0 p-2 border-t border-slate-700/50 bg-slate-800/40">
        <button
        ...
        >
          ...
          {!isCollapsed && (
            <span className="hidden md:inline text-[13px] font-semibold">Sign Out</span>
          )}
          <span className="md:hidden text-[13px] font-semibold">Sign Out</span>
        </button>
      </div>
    </aside>
  );
