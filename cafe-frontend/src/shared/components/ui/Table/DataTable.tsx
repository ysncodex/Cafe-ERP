...
export function DataTableHeadCell({
  ...
  return (
    <th
      scope="col"
      className={`px-4 py-3 text-[11px] font-bold uppercase tracking-wide text-slate-500 whitespace-nowrap ${alignClass[align]} ${className}`}
      {...props}
    >
      {children}
    </th>
...
export function DataTableCell({
  ...
  return (
    <td
      className={`px-4 py-3 align-middle text-sm ${alignClass[align]} ${className}`}
      {...props}
    >
      {children}
    </td>
