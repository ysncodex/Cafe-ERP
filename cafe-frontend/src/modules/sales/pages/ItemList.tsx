...
} from '../utils/menuCatalog.storage';
import {
  ALL_CATEGORIES,
  CATEGORY_STYLES,
...
function ProductCard({ item, onEdit, onDelete, onToggle }: ProductCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="p-3.5">
        ...
        <div className="flex items-center justify-between">
          ...
          {/* Plus button (visible when not hovering with actions) */}
          <button
            onClick={() => onEdit(item)}
...
export default function ItemList() {
  ...
  // ── Handlers ──
  const handleAdd = useCallback((data: Omit<MenuItem, 'id'>) => {
  ...
  const handleEdit = useCallback((data: Omit<MenuItem, 'id'>) => {
